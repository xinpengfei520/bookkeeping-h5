...
(function () {
    var init = function (obj) {
        ...
        var parent =
            ...
            size +
            "</td>" +
            "<td class='src'><div style='overflow:hidden'><div id='totalBar' style='float:left;width:80%;height:30px;border:1px solid;border-radius:3px'>" +
            "<div id='totalBarColor' style='width:0;border:0;background-color:rgba(232,152,39,0.8);height:28px;'></div>" +
            "<p class='speed'></p>" +
            "</div>" +
            "<div class='control-container' class='target'>" +
